import { Serialization, PropertyInfo, TypeMetadata, StringUtil, Enumerable, Coalesce, StringBuilder } from '@brandless/tsutility';
...
var DummyClass = /** @class */ (function () {
    ...
    DummyClass.prototype.toJSON = function () {
        return Serialization.PrepareForJson(this, DummyClass);
    };
...
var TsBeautifyOptions = /** @class */ (function () {
    ...
    TsBeautifyOptions.PropertiesDeclared = function () {
        return new Array(new PropertyInfo("_TsBeautifyOptions_OpenBlockOnNewLine", TsBeautifyOptions, TypeMetadata.Parse("boolean"), false, false), new PropertyInfo("_TsBeautifyOptions_IndentSize", TsBeautifyOptions, TypeMetadata.Parse("number"), false, false), new PropertyInfo("_TsBeautifyOptions_IndentChar", TsBeautifyOptions, TypeMetadata.Parse("number"), false, false), new PropertyInfo("_TsBeautifyOptions_IndentLevel", TsBeautifyOptions, TypeMetadata.Parse("number"), false, false), new PropertyInfo("_TsBeautifyOptions_PreserveNewlines", TsBeautifyOptions, TypeMetadata.Parse("boolean"), false, false), new PropertyInfo("<OpenBlockOnNewLine>k__BackingField", TsBeautifyOptions, TypeMetadata.Parse("System.Boolean"), false, true), new PropertyInfo("OpenBlockOnNewLine", TsBeautifyOptions, TypeMetadata.Parse("System.Boolean"), true, false), new PropertyInfo("<IndentSize>k__BackingField", TsBeautifyOptions, TypeMetadata.Parse("System.Nullable?"), false, true), new PropertyInfo("IndentSize", TsBeautifyOptions, TypeMetadata.Parse("System.Nullable?"), true, false), new PropertyInfo("<IndentChar>k__BackingField", TsBeautifyOptions, TypeMetadata.Parse("System.Nullable?"), false, true), new PropertyInfo("IndentChar", TsBeautifyOptions, TypeMetadata.Parse("System.Nullable?"), true, false), new PropertyInfo("<IndentLevel>k__BackingField", TsBeautifyOptions, TypeMetadata.Parse("System.Nullable?"), false, true), new PropertyInfo("IndentLevel", TsBeautifyOptions, TypeMetadata.Parse("System.Nullable?"), true, false), new PropertyInfo("<PreserveNewlines>k__BackingField", TsBeautifyOptions, TypeMetadata.Parse("System.Nullable?"), false, true), new PropertyInfo("PreserveNewlines", TsBeautifyOptions, TypeMetadata.Parse("System.Nullable?"), true, false));
    };
    ...
    TsBeautifyOptions.prototype.toJSON = function () {
        return Serialization.PrepareForJson(this, TsBeautifyOptions);
    };
...
var StringExtensions = /** @class */ (function () {
    ...
    StringExtensions.StartsWithAt = function (str, toLookFor, atPosititon) {
        ...
        for (var i = 0; i < toLookFor.length; i++) {
            var ch = StringUtil.CharCodeAt(toLookFor, i);
            if (StringUtil.CharCodeAt(str, pos) != ch) {
                return (false);
            }
            pos++;
        }
    ...
    StringExtensions.prototype.toJSON = function () {
        return Serialization.PrepareForJson(this, StringExtensions);
    };
...
var TsBeautifierInstance = /** @class */ (function () {
    function TsBeautifierInstance(jsSourceText, options, interpolation) {
        ...
        options = Coalesce(options, function () { return new TsBeautifyOptions(); });
        this._options = options;
        var optIndentSize = Coalesce(options.IndentSize, function () { return 4; });
        var optIndentChar = Coalesce(options.IndentChar, function () { return ' '.charCodeAt(0); });
        var optIndentLevel = Coalesce(options.IndentLevel, function () { return 0; });
        this._optPreserveNewlines = Coalesce(options.PreserveNewlines, function () { return true; });
        this._output = new StringBuilder();
        this._modes = new Array();
        this._indentString = "";
        while (optIndentSize > 0) {
            this._indentString += StringUtil.EnsureChar(optIndentChar);
            optIndentSize -= 1;
        }
    ...
    TsBeautifierInstance.PropertiesDeclared = function () {
        return new Array(new PropertyInfo("_TsBeautifierInstance_Interpolation", TsBeautifierInstance, TypeMetadata.Parse("boolean"), false, false), new PropertyInfo("_TsBeautifierInstance_InGenerics", TsBeautifierInstance, TypeMetadata.Parse("boolean"), false, false), new PropertyInfo("WhitespaceChars", TsBeautifierInstance, TypeMetadata.Parse("System.String"), false, true), new PropertyInfo("WordChars", TsBeautifierInstance, TypeMetadata.Parse("System.String"), false, true), new PropertyInfo("Chars", TsBeautifierInstance, TypeMetadata.Parse("System.String"), false, true), new PropertyInfo("GenericsChars", TsBeautifierInstance, TypeMetadata.Parse("System.String"), false, true), new PropertyInfo("_digits", TsBeautifierInstance, TypeMetadata.Parse("System.Collections.Generic.Dictionary<System.String, System.Boolean>"), false, true), new PropertyInfo("_digitsChars", TsBeautifierInstance, TypeMetadata.Parse("System.Collections.Generic.Dictionary<System.Char, System.Boolean>"), false, true), new PropertyInfo("_generics", TsBeautifierInstance, TypeMetadata.Parse("System.Collections.Generic.Dictionary<System.String, System.Boolean>"), false, true), new PropertyInfo("_genericsBrackets", TsBeautifierInstance, TypeMetadata.Parse("System.Collections.Generic.Dictionary<System.String, System.Boolean>"), false, true), new PropertyInfo("_genericsBracketsChars", TsBeautifierInstance, TypeMetadata.Parse("System.Collections.Generic.Dictionary<System.Char, System.Boolean>"), false, true), new PropertyInfo("_genericsChars", TsBeautifierInstance, TypeMetadata.Parse("System.Collections.Generic.Dictionary<System.Char, System.Boolean>"), false, true), new PropertyInfo("_indentString", TsBeautifierInstance, TypeMetadata.Parse("System.String"), false, true), new PropertyInfo("_input", TsBeautifierInstance, TypeMetadata.Parse("System.String"), false, true), new PropertyInfo("_lineStarters", TsBeautifierInstance, TypeMetadata.Parse("System.Collections.Generic.Dictionary<System.String, System.Boolean>"), false, true), new PropertyInfo("_modes", TsBeautifierInstance, TypeMetadata.Parse("System.Collections.Generic.Stack<TsBeautify.TsMode>"), false, true), new PropertyInfo("_options", TsBeautifierInstance, TypeMetadata.Parse("TsBeautify.TsBeautifyOptions"), false, true), new PropertyInfo("_optPreserveNewlines", TsBeautifierInstance, TypeMetadata.Parse("System.Boolean"), false, true), new PropertyInfo("_output", TsBeautifierInstance, TypeMetadata.Parse("System.Text.StringBuilder"), false, true), new PropertyInfo("_punctuation", TsBeautifierInstance, TypeMetadata.Parse("System.Collections.Generic.Dictionary<System.String, System.Boolean>"), false, true), new PropertyInfo("_whitespace", TsBeautifierInstance, TypeMetadata.Parse("System.Collections.Generic.Dictionary<System.String, System.Boolean>"), false, true), new PropertyInfo("_whitespaceChars", TsBeautifierInstance, TypeMetadata.Parse("System.Collections.Generic.Dictionary<System.Char, System.Boolean>"), false, true), new PropertyInfo("_wordchar", TsBeautifierInstance, TypeMetadata.Parse("System.Collections.Generic.Dictionary<System.String, System.Boolean>"), false, true), new PropertyInfo("_wordcharChars", TsBeautifierInstance, TypeMetadata.Parse("System.Collections.Generic.Dictionary<System.Char, System.Boolean>"), false, true), new PropertyInfo("_currentMode", TsBeautifierInstance, TypeMetadata.Parse("TsBeautify.TsMode"), false, true), new PropertyInfo("_doBlockJustClosed", TsBeautifierInstance, TypeMetadata.Parse("System.Boolean"), false, true), new PropertyInfo("_genericsDepth", TsBeautifierInstance, TypeMetadata.Parse("System.Int32"), false, true), new PropertyInfo("_ifLineFlag", TsBeautifierInstance, TypeMetadata.Parse("System.Boolean"), false, true), new PropertyInfo("_indentLevel", TsBeautifierInstance, TypeMetadata.Parse("System.Int32"), false, true), new PropertyInfo("_isImportBlock", TsBeautifierInstance, TypeMetadata.Parse("System.Boolean"), false, true), new PropertyInfo("_secondToLastChar", TsBeautifierInstance, TypeMetadata.Parse("System.Char"), false, true), new PropertyInfo("_secondToLastCharIndex", TsBeautifierInstance, TypeMetadata.Parse("System.Int32"), false, true), new PropertyInfo("_currentInputChar", TsBeautifierInstance, TypeMetadata.Parse("System.Char"), false, true), new PropertyInfo("_currentInputCharIndex", TsBeautifierInstance, TypeMetadata.Parse("System.Int32"), false, true), new PropertyInfo("_lastText", TsBeautifierInstance, TypeMetadata.Parse("System.String"), false, true), new PropertyInfo("_lastType", TsBeautifierInstance, TypeMetadata.Parse("TsBeautify.TokenType"), false, true), new PropertyInfo("_parserPos", TsBeautifierInstance, TypeMetadata.Parse("System.Int32"), false, true), new PropertyInfo("_token", TsBeautifierInstance, TypeMetadata.Parse("TsBeautify.Token"), false, true), new PropertyInfo("_tokenText", TsBeautifierInstance, TypeMetadata.Parse("System.String"), false, true), new PropertyInfo("<Interpolation>k__BackingField", TsBeautifierInstance, TypeMetadata.Parse("System.Boolean"), false, true), new PropertyInfo("Interpolation", TsBeautifierInstance, TypeMetadata.Parse("System.Boolean"), true, false), new PropertyInfo("InGenerics", TsBeautifierInstance, TypeMetadata.Parse("System.Boolean"), false, false), new PropertyInfo("SecondToLastChar", TsBeautifierInstance, TypeMetadata.Parse("System.Char"), true, false), new PropertyInfo("CurrentInputChar", TsBeautifierInstance, TypeMetadata.Parse("System.Char"), true, false));
    };
    ...
    TsBeautifierInstance.prototype.TsBeautifierInstance_SecondToLastCharGetter = function () {
        if (this._secondToLastCharIndex != this._output.Length) {
            ...
            this._secondToLastChar = StringUtil.CharCodeAt(this._output, this._output.Length - 1);
        }
    ...
    TsBeautifierInstance.prototype.TsBeautifierInstance_CurrentInputCharGetter = function () {
        if (this._currentInputCharIndex != this._parserPos) {
            ...
            this._currentInputChar = StringUtil.CharCodeAt(this._input, this._parserPos);
        }
        return (this._currentInputChar);
    };
    TsBeautifierInstance.ToLookup = function (str) {
        var chars = StringUtil.ToCharArray(str);
        var dic = new Map();
        for (var i = 0; i < chars.length; i++) {
            dic.set((StringUtil.EnsureChar(StringUtil.CharCodeAt(chars, i))), true);
        }
        return dic;
    };
    TsBeautifierInstance.ArrayToLookup = function (str) {
        var strings = Enumerable.ToList(str);
        var dic = new Map();
    ...
    TsBeautifierInstance.ToCharLookup = function (lookup) {
        ...
        try {
            for (var _b = __values(lookup.entries()), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                dic.set(StringUtil.CharCodeAt(_ts1Key, 0), true);
            }
        }
            ...
            switch (tokenType) {
                ...
                case TokenType.Word:
                    ...
                    if (this._lastType == TokenType.EndBlock) {
                        if (!(Enumerable.Contains(["else", "catch", "finally"], (this._tokenText.toLowerCase())))) {
                            prefix = "NEWLINE";
                        }
                        else {
                            prefix = "SPACE";
                    ...
                    if (this._lastType != TokenType.EndBlock && (Enumerable.Contains(["else", "catch", "finally"], (this._tokenText.toLowerCase())))) {
                        this.PrintNewLine();
                    }
    ...
    TsBeautifierInstance.prototype.TrimOutput = function () {
        while (this._output.Length > 0 && (this.SecondToLastChar == ' '.charCodeAt(0) || this.SecondToLastChar == StringUtil.CharCodeAt(this._indentString, 0))) {
    ...
    TsBeautifierInstance.prototype.PrintNewLine = function (ignoreRepeated) {
        ...
        ignoreRepeated = Coalesce(ignoreRepeated, function () { return true; });
        this._ifLineFlag = false;
        this.TrimOutput();
    ...
    TsBeautifierInstance.prototype.PrintSpace = function () {
        if (this.SecondToLastChar != ' '.charCodeAt(0) && this.SecondToLastChar != '\n'.charCodeAt(0) && this.SecondToLastChar != StringUtil.CharCodeAt(this._indentString, 0)) {
    ...
    TsBeautifierInstance.prototype.RemoveIndent = function () {
        if (this._output.Length > 0 && this.SecondToLastChar == StringUtil.CharCodeAt(this._indentString, 0)) {
            this._output.Remove(this._output.Length - 1, 1);
        }
    };
    ...
    TsBeautifierInstance.prototype.IsTernaryOperation = function () {
        ...
        for (var i = this._output.Length - 1; i >= 0; i--) {
            switch (StringUtil.CharCodeAt(this._output, i)) {
                case ':'.charCodeAt(0):
                    if (level == 0) {
                        colonCount++;
                    }
    ...
    TsBeautifierInstance.prototype.GetNextToken = function () {
        ...
        //    return;
        //}
        var currentString = (StringUtil.EnsureChar(retrievedChar));
        ...
        if (retrievedChar == '<'.charCodeAt(0)) {
            if (this.InGenerics) {
                ...
                for (var i = this._parserPos + 1; i < this._input.length; i++) {
                    var cSub = StringUtil.CharCodeAt(this._input, i);
        ...
        if ((this._wordcharChars.has(retrievedChar)) || (retrievedChar == '@'.charCodeAt(0)) && (this._wordcharChars.has(this.CurrentInputChar))) {
            if (this._parserPos < this._input.length) {
                while ((this._wordcharChars.has(this.CurrentInputChar))) {
                    currentString += StringUtil.EnsureChar(this.CurrentInputChar);
                    this._parserPos++;
                    if (this._parserPos == this._input.length) {
                        break;
                    }
            ...
            if ((this.CurrentInputChar == '-'.charCodeAt(0) || this.CurrentInputChar == '+'.charCodeAt(0)) && this._parserPos != this._input.length && (new RegExp("^[0-9]+[Ee]$", "g").test(currentString))) {
                ...
                this._parserPos++;
                this.GetNextToken();
                currentString += StringUtil.EnsureChar(sign) + this._token.Value;
        ...
        if (retrievedChar == '/'.charCodeAt(0)) {
            ...
            if (this.CurrentInputChar == '*'.charCodeAt(0)) {
                this._parserPos++;
                if (this._parserPos < this._input.length) {
                    while (!(this.CurrentInputChar == '*'.charCodeAt(0) && StringUtil.CharCodeAt(this._input, this._parserPos + 1) > '\0'.charCodeAt(0) && StringUtil.CharCodeAt(this._input, this._parserPos + 1) == '/'.charCodeAt(0) && this._parserPos < this._input.length)) {
                        comment += StringUtil.EnsureChar(this.CurrentInputChar);
                        this._parserPos++;
                        if (this._parserPos >= this._input.length) {
                            break;
                        }
        ...
        if (retrievedChar == '$'.charCodeAt(0) || this._lastText == "$") {
            ...
            if (next == '@'.charCodeAt(0) || next == '"'.charCodeAt(0)) {
                ...
                if (lookahead == 1) {
                    this._output.Append(StringUtil.EnsureChar(/*5*/ retrievedChar));
                    retrievedChar = this.CurrentInputChar;
                    currentString = (StringUtil.EnsureChar(retrievedChar));
                    this._parserPos++;
                }
            }
        }
        ...
        if ((isQuote || retrievedChar == '/'.charCodeAt(0)) && (this._lastType == TokenType.Word && (this._lastText == "$" || this._lastText == "return" || this._lastText == "from" || this._lastText == "case") || (isQuote && this._lastType == TokenType.Word) || this._lastType == TokenType.StartExpression || this._lastType == TokenType.BlockComment || this._lastType == TokenType.Comment || this._lastType == TokenType.StartBlock || this._lastType == TokenType.EndBlock || this._lastType == TokenType.Operator || this._lastType == TokenType.Generics || this._lastType == TokenType.EndOfFile || this._lastType == TokenType.SemiColon)) {
            ...
            if (this._parserPos < this._input.length) {
                if (sep == '/'.charCodeAt(0)) {
                    ...
                    while (esc || inCharClass || this.CurrentInputChar != sep) {
                        resultingString.Append(StringUtil.EnsureChar(/*5*/ this.CurrentInputChar));
                        if (!esc) {
                            ...
                            case StringInterpolationKind.TypeScript:
                                if ((StringExtensions.StartsWithAt(this._input, "${", this._parserPos))) {
                                    ...
                                    for (var i = this._parserPos - 1; i > 0; i--) {
                                        if (StringUtil.CharCodeAt(this._input, i) == '\\'.charCodeAt(0)) {
                                            escapeCount++;
                                        }
                                        else {
                                            break;
                                ...
                                case StringInterpolationKind.CSharp:
                                    {
                                        ...
                                        var interpolated = ((StringUtil.TrimStart((sub.Beautify()), '{'.charCodeAt(0))).trim());
            ...
            this._parserPos += 1;
            resultingString.Append(StringUtil.EnsureChar(/*5*/ sep));
            if (sep == '/'.charCodeAt(0)) {
        ...
        if (retrievedChar == '#'.charCodeAt(0)) {
            ...
            if (this._parserPos < this._input.length && (this._digitsChars.has(this.CurrentInputChar))) {
                do {
                    retrievedChar = this.CurrentInputChar;
                    sharp += StringUtil.EnsureChar(retrievedChar);
                    this._parserPos += 1;
        ...
        if ((this._punctuation.has(currentString))) {
            while (this._parserPos < this._input.length && (this._punctuation.has(currentString + StringUtil.EnsureChar(this.CurrentInputChar)))) {
                currentString += StringUtil.EnsureChar(this.CurrentInputChar);
                this._parserPos += 1;
                if (this._parserPos >= this._input.length) {
                    break;
    ...
    TsBeautifierInstance.prototype.At = function (position) {
        ...
        return (StringUtil.CharCodeAt(this._input, position));
    };
...
var Token = /** @class */ (function () {
    ...
    Token.PropertiesDeclared = function () {
        return new Array(new PropertyInfo("_Token_Value", Token, TypeMetadata.Parse("string"), false, false), new PropertyInfo("_Token_TokenType", Token, TypeMetadata.Parse("TokenType"), false, false), new PropertyInfo("_Token_NewLineCount", Token, TypeMetadata.Parse("number"), false, false), new PropertyInfo("<Value>k__BackingField", Token, TypeMetadata.Parse("System.String"), false, true), new PropertyInfo("Value", Token, TypeMetadata.Parse("System.String"), true, false), new PropertyInfo("<TokenType>k__BackingField", Token, TypeMetadata.Parse("TsBeautify.TokenType"), false, true), new PropertyInfo("TokenType", Token, TypeMetadata.Parse("TsBeautify.TokenType"), true, false), new PropertyInfo("<NewLineCount>k__BackingField", Token, TypeMetadata.Parse("System.Int32"), false, true), new PropertyInfo("NewLineCount", Token, TypeMetadata.Parse("System.Int32"), true, false));
    };
...
var TsBeautifier = /** @class */ (function () {
    function TsBeautifier(options) {
        if (options === void 0) { options = null; }
        this.Options = Coalesce(options, function () { return new TsBeautifyOptions(); });
    }
    ...
    TsBeautifier.PropertiesDeclared = function () {
        return new Array(new PropertyInfo("_TsBeautifier_Options", TsBeautifier, TypeMetadata.Parse("TsBeautifyOptions"), false, false), new PropertyInfo("<Options>k__BackingField", TsBeautifier, TypeMetadata.Parse("TsBeautify.TsBeautifyOptions"), false, true), new PropertyInfo("Options", TsBeautifier, TypeMetadata.Parse("TsBeautify.TsBeautifyOptions"), true, false));
    };
    ...
    TsBeautifier.prototype.toJSON = function () {
        return Serialization.PrepareForJson(this, TsBeautifier);
    };
...
export { DummyClass, StringExtensions, TsBeautifier, TsBeautifyOptions };
